...
/// Basic frame/variable navigation and frame label formatting.
mod cursor_tests {
    use super::*;
...
/// Object expansion state machine: loading, done, failed, and cancel transitions.
...
/// Flat item list rendering: loading nodes, field rows, and failed expansions.
...
/// Cyclic reference detection, recursive collapse guards, and diamond patterns.
mod cycle_tests {
    use super::*;
...
/// Collection chunk pagination ranges and page up/down cursor jumps.
...
/// Field value display style selection by value type.
...
/// Viewport scroll offset management and cursor-centering logic.
mod scroll_tests {
    use super::*;
...
/// NavigationPath construction, parent resolution, and left/right traversal.
